...
{ 
  ...
  main.variable(observer("D3_Mapping_On_Canvas")).define("D3_Mapping_On_Canvas", ["d3Geo","d3","d3GeoProj","model","topojson","Stats","context"], function(d3Geo,d3,d3GeoProj,model,topojson,Stats,context)
{
